...
namespace LSL.Services
{
    ...
    public class ConfigManager
    {
        ...
        public static readonly IReadOnlyList<string> ConfigKeys = new List<string>()
        {
            //Common
            "auto_eula",
            "app_priority",
        ...
        public void ConfirmConfig(Dictionary<string, object> confs)
        {
        ...
        #region 读取配置键值
        // 当前配置字典
        public readonly Dictionary<string, object> CurrentConfigs = [];
    ...
    public class ServerConfigManager(ConfigManager cfm)//服务器配置相关服务
    {
        private ConfigManager _configManager { get; } = cfm;
        public Dictionary<int, string> MainServerConfig = [];

        public Dictionary<int, ServerConfig> ServerConfigs = [];

        public readonly List<string> ServerConfigKeys =
            [
                "name",
                "using_java",
                "core_name",
        ...
        public ServiceResult LoadServerConfigs()
        {
            ServerConfigs = [];
        ...
        public void RegisterServer(string serverName, string usingJava, string corePath, uint maxMem, uint minMem, string extJVM)
        {
            ...
            // 创建Eula文件
            bool eula = (bool)_configManager.CurrentConfigs["auto_eula"];
        ...
        public void EditServer(int serverId, string serverName, string usingJava, uint minMem, uint maxMem, string extJVM)
        {
    ...
    public class JavaManager//Java相关服务
    {
        ...
        public Dictionary<int, JavaInfo> JavaDict = [];// 目前读取的Java列表
