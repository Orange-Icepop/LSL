...
public interface IConfigManager<TConfig>
{
    ...
    /// </summary>
    /// <returns>
    ///     The config. Returns a warning when correctable errors occured and was fixed. Returns an error if it's
    ///     uncorrectable, such as an IOException.
    /// </returns>
    ...
    /// <returns>
    ///     The fixed config. Returns a warning if illegal values are set. Returns an error when uncorrectable issues
    ///     occured, such as an IOException.
    /// </returns>
