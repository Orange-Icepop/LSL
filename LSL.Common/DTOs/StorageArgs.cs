...
public record ColorOutputArgs(int ServerId, string Output, string ColorHex) : IServerMessage;
...
public record ServerStatusArgs(int ServerId, bool IsRunning, bool IsOnline) : IServerMessage;
